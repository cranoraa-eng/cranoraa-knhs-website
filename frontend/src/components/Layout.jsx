...
const Layout = () => {
  ...
  const pageTitle = useMemo(() => {
    ...
    if (path === '/grading-suite') return 'Grading Suite';
  ...
  const searchSuggestions = useMemo(() => {
    ...
    const roleSuggestions = {
      student: [
        ...
        { label: 'My Grades', path: '/grading-suite', category: 'Academics', description: 'View your grades and report card' },
      ],
      staff: [
        ...
        { label: 'Grading Suite', path: '/grading-suite', category: 'Teaching', description: 'Input and manage student grades' },
        { label: 'Attendance', path: '/attendance', category: 'Teaching', description: 'Mark and view attendance records' },
      ...
      admin: [
        ...
        { label: 'Grading Suite', path: '/grading-suite', category: 'Management', description: 'View and manage all student grades' },
        { label: 'Attendance', path: '/attendance', category: 'Management', description: 'View and manage attendance records' },
    ...
    student: [
      {
        ...
        items: [
          ...
          { to: '/my-classes', label: 'My Classes', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
          { to: '/my-schedule', label: 'My Schedule', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z' },
          { to: '/grading-suite', label: 'My Grades', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
          { to: '/attendance', label: 'My Attendance', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4' },
          { to: '/communication-center', label: 'Communication Center', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
        ]
      },
      {

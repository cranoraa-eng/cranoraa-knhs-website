...
const Announcements = () => {
  ...
  return (
    <div className="animate-fade-in page-bottom-safe min-h-0 -mx-3 md:-mx-6 bg-[#f0f2f5]">
      ...
      <div className="bg-white border-b-4 border-violet-600 px-4 md:px-6 py-3 md:py-4 mb-3 md:mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {(a.priority === 'critical' || a.is_public || stat.label !== 'Live') && (
                        <div className="flex flex-wrap gap-1 mt-2">
                          ...
                          {a.is_public && (
                            <span className="px-2 py-0.5 rounded-full bg-violet-50 text-violet-700 text-[10px] font-bold uppercase">Public</span>
                          )}
                          {stat.label !== 'Live' && (

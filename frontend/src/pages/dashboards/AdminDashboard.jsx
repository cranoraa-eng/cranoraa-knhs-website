      ...
      <div className={`transition-opacity duration-200 ${statOverlay ? 'opacity-60 pointer-events-none' : 'opacity-100'}`}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-6 gap-3 md:gap-4">
          ...
          <StatCard
            ...
            color="sky" onClick={() => navigate('/enrollment-classes?tab=classrooms')}
          />
          <StatCard
          ...
          <StatCard
            ...
            color="rose" onClick={() => navigate('/moderation')} badge={data?.pending_approvals}
          />
          <StatCard
        ...
        <div className="space-y-5 md:space-y-6">
          ...
          <Card>
            ...
            <CardBody className="space-y-2">
              {[
                { label: 'Audit Logs',    path: '/audit-logs',    icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
                { label: 'System Health', path: '/system-health', icon: 'M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18' },

        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 md:w-16 md:h-16 rounded-md bg-white p-2 flex items-center justify-center border-2 border-slate-200 shadow-sm shrink-0">
              <img src="/icons/school-logo-source.png" alt="KNHS Seal" className="w-full h-full object-contain" />
            </div>
            <div>
  ...
  return (
    <Card
      ...
      className={cn(
        ...
        color === 'sky' && "border-l-sky-500 hover:border-l-sky-600",
      ...
      <CardBody>
        {loading ? (
          <div className="space-y-2">
            {[1, 2, 3].map(i => <div key={i} className="h-16 bg-slate-100 animate-pulse rounded-md" />)}
          </div>
        ) : schedule.length === 0 ? (
          <EmptyState

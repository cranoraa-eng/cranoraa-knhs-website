...
const StudentManagement = () => {
  ...
  return (
    <div className="overflow-y-auto h-[calc(100vh-4rem)] p-4 md:p-6 space-y-6 bg-gray-50/50">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-2xl md:text-3xl font-black text-gray-800 tracking-tight">Student Management</h1>
          <p className="text-gray-500 text-sm md:text-base mt-1 font-medium">Organized view of all registered students by grade and classroom</p>
        </div>
        <div className="bg-white px-5 py-2.5 rounded-2xl border border-gray-200 shadow-sm flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xl font-black text-gray-800 leading-none">{students.length}</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-10 pb-10">
        {organizedData.length === 0 ? (
          <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-20 text-center">
            ...
            <h3 className="text-2xl font-black text-gray-700 mb-2">No Students Found</h3>
            <p className="text-gray-400 font-medium max-w-xs mx-auto">Try searching for a different name or LRN.</p>
          </div>
        ) : (
          organizedData.map((gradeGroup) => (
            <div key={gradeGroup.grade} className="space-y-6">
              <div className="flex items-center gap-4 px-2">
                <h2 className="text-xl font-black text-gray-800 uppercase tracking-tight">{gradeGroup.grade}</h2>
                <div className="h-px flex-1 bg-gradient-to-r from-gray-200 to-transparent"></div>
              </div>

              <div className="grid grid-cols-1 gap-8">
                {gradeGroup.classrooms.map((cls) => (
                  <div key={cls.name} className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                    <div className="px-6 py-4 bg-gray-50 border-b border-gray-100 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <h3 className="font-black text-gray-700 text-sm uppercase tracking-wider">{cls.name}</h3>
                      </div>

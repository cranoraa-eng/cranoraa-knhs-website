      ...
      case 'assign-teachers':
        return (
          <div className="space-y-6">
            ...
            <div className="text-center">
              <Button variant="secondary" size="sm" onClick={() => navigate('/people?tab=teachers')}>
        ...
        return (
          <div className="space-y-6">
            ...
            <div className="text-center py-8 bg-slate-50 rounded-xl border border-dashed border-slate-300 max-w-lg mx-auto">
              ...
              <Button variant="primary" onClick={() => navigate('/subjects?tab=assignments')}>
        ...
        return (
          <div className="space-y-6 text-center">
            ...
            <div className="flex justify-center gap-3">
              ...
              <Button variant="secondary" onClick={() => navigate('/classes?tab=sections')}>

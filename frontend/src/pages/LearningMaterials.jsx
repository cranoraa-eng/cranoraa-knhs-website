    ...
    <div className="bg-white">
      ...
      <section className="bg-purple-700 py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
              <p className="text-xs font-bold text-purple-200 uppercase tracking-widest mb-4">Resources</p>
      ...
      <section className="py-16 md:py-20 bg-purple-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl border-2 border-purple-200 p-8 md:p-12 text-center shadow-lg">
            <div className="w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-6">
              <svg className="w-10 h-10 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
            </div>
            <h2 className="text-2xl font-black text-purple-800 mb-4 uppercase">Portal Login Required</h2>
            ...
            <Link to="/login" className="inline-flex items-center gap-2 px-8 py-4 bg-purple-600 text-white rounded-xl font-black hover:bg-purple-700 transition-colors uppercase">
              Login to Portal
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black text-purple-800 mb-3 uppercase">Available Resources</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="bg-purple-50 rounded-2xl border-2 border-purple-200 p-6 hover:shadow-lg transition-all">
                ...
                <h3 className="text-lg font-black text-purple-800 mb-2 uppercase">{resource.title}</h3>

        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-slate-500 font-medium leading-relaxed">
              {content.contact_subtitle || 'Have questions about enrollment or our programs? We are here to help and answer any questions you might have.'}
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <div className="lg:col-span-5 space-y-6">
              {[
                { 
                  title: 'Visit Us', 
                  val: content.contact_address || 'Kiwalan, Philippines', 
                  icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z',
                  color: 'violet'
                },
                { 
                  title: 'Email Us', 
                  val: content.contact_email || 'info@kiwalan-nhs.edu.ph', 
                  icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',
                  color: 'blue'
                },
                { 
                  title: 'Call Us', 
                  val: content.contact_phone || '(123) 456-7890', 
                  icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z',
                  color: 'indigo'
                },
                { 
                  title: 'Office Hours', 
                  val: content.contact_office_hours || 'Mon - Fri: 7AM - 5PM', 

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start bg-gradient-to-r from-purple-50 to-transparent p-6 rounded-xl hover:shadow-md transition-shadow">
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-purple-700 rounded-2xl flex items-center justify-center mr-6 flex-shrink-0 shadow-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">{content.contact_address || 'Kiwalan, Philippines'}</p>
                  </div>
                </div>

                <div className="flex items-start bg-gradient-to-r from-blue-50 to-transparent p-6 rounded-xl hover:shadow-md transition-shadow">
                  <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-700 rounded-2xl flex items-center justify-center mr-6 flex-shrink-0 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">{content.contact_email || 'info@kiwalan-nhs.edu.ph'}</p>
                  </div>
                </div>

                <div className="flex items-start bg-gradient-to-r from-green-50 to-transparent p-6 rounded-xl hover:shadow-md transition-shadow">
                  <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-green-700 rounded-2xl flex items-center justify-center mr-6 flex-shrink-0 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">{content.contact_phone || '(123) 456-7890'}</p>
                  </div>
                </div>

                <div className="flex items-start bg-gradient-to-r from-orange-50 to-transparent p-6 rounded-xl hover:shadow-md transition-shadow">
                  <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-700 rounded-2xl flex items-center justify-center mr-6 flex-shrink-0 shadow-lg">
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg whitespace-pre-line">{content.contact_office_hours || 'Monday - Friday: 7:00 AM - 5:00 PM\nSaturday: 8:00 AM - 12:00 PM'}</p>
                  </div>
                </div>
              </div>
            ...
            <div>
              ...
              <form className="space-y-6 bg-gradient-to-br from-purple-50 to-white p-10 rounded-xl shadow-lg">
                <div>
                ...
                <button
                  type="submit"
                  className="w-full bg-purple-600 text-white font-bold py-4 px-6 rounded-lg hover:bg-purple-700 transition-all transform hover:scale-105 shadow-lg"
                >
                  Send Message
                </button>
              </form>
          ...
          <div className="mt-20 text-center">
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 p-12 rounded-xl shadow-md">
              ...
              <p className="text-gray-600 mb-8 text-lg">Visit our campus or call us during office hours for urgent matters.</p>
              <Link
                to="/login"

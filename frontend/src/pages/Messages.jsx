                              ...
                              <div className="relative">
                                ...
                                {showReactionPicker === msg.id && (
                                  <>
                                    ...
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-white border border-slate-200 rounded-2xl shadow-xl p-1 md:p-1.5 flex gap-0.5 md:gap-1 z-[100] animate-in fade-in slide-in-from-bottom-2 max-w-[90vw] whitespace-nowrap">
                              ...
                              <div className="relative">
                                ...
                                {activeMoreMenu === msg.id && (
                                  <>
                                    ...
                                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-32 bg-white border border-slate-200 rounded-xl shadow-xl overflow-hidden z-[100] animate-in fade-in slide-in-from-bottom-2">
                                      <div className="py-1">

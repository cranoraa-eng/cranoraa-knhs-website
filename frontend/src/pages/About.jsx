        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-7xl font-black mb-8 text-white leading-tight animate-fadeIn">
              {content.about_title || 'About Our School'}
            </h1>
            <p className="text-xl text-slate-300 font-medium leading-relaxed animate-fadeIn delay-100">
              {content.about_subtitle || 'Learn about our history, mission, and the values that drive our commitment to excellence in education.'}
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
            <div className="space-y-12">
              <div className="group p-10 rounded-[2.5rem] bg-violet-50 border border-violet-100 hover:shadow-2xl transition-all duration-300">
                ...
                <h2 className="text-3xl font-black text-slate-900 mb-6">{content.about_mission_title || 'Our Mission'}</h2>
                <p className="text-lg text-slate-600 font-medium leading-relaxed whitespace-pre-line">
                  {content.about_mission_content || 'To provide quality education that develops students academic excellence, moral character, and practical skills.'}
                </p>
              </div>
              ...
              <div className="group p-10 rounded-[2.5rem] bg-indigo-50 border border-indigo-100 hover:shadow-2xl transition-all duration-300">
                ...
                <h2 className="text-3xl font-black text-slate-900 mb-6">{content.about_vision_title || 'Our Vision'}</h2>
                <p className="text-lg text-slate-600 font-medium leading-relaxed whitespace-pre-line">
                  {content.about_vision_content || 'To be a leading educational institution recognized for academic excellence and innovative teaching methods.'}
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h3 className="text-4xl md:text-5xl font-black text-slate-900">{content.about_history_title || 'Our History'}</h3>
            </div>

  ...
  return (
    <div className="page-bottom-safe bg-slate-50/50">
      <div className="mb-4 md:mb-6">
        ...
        <p className="text-xs text-slate-500 mt-1">Enrollment Applications</p>
      </div>
...
function EnrollStudentsTab({ refetch }) {
  ...
  return (
    <div className="page-bottom-safe bg-slate-50/50">
      <div className="mb-4 md:mb-6">
        <h1 className="text-xl md:text-2xl font-extrabold text-slate-900 tracking-tight">Enroll Students</h1>
        <p className="text-xs text-slate-500 mt-1">Assign approved students to classroom sections</p>
      </div>
      ...
      <div className="bg-white border-b-2 border-slate-200 px-4 md:px-6 py-4 mb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-extrabold text-slate-900">Enrollment Hub</h1>
              <p className="text-sm text-slate-500">Manage enrollment applications and student assignments</p>
            </div>
          </div>
          <div className="flex gap-2">
            {tabs.map(tab => (

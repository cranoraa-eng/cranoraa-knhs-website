        ...
        <div className="flex-1 p-3 space-y-2.5 overflow-hidden">
          ...
          <div className="grid grid-cols-3 gap-1.5">
            {[
              ...
              { label: 'Subjects', val: '8', color: 'bg-violet-500/20 text-violet-400' },
            ].map((s, i) => (
          ...
          <div className="rounded-lg bg-white/5 border border-white/5 p-2">
            ...
            <div className="space-y-1">
              {[['Math', 92, 'bg-violet-500'], ['Science', 87, 'bg-violet-500'], ['English', 90, 'bg-emerald-500']].map(([sub, pct, color]) => (
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 w-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-7">
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-violet-500/10 border border-blue-500/20">
      ...
      <section className="py-20 md:py-28 bg-[#0f0720] relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              { role: 'Students', color: 'border-blue-500/30 bg-violet-500/5', badge: 'bg-violet-500/20 text-violet-300', features: ['View grades & report cards', 'Track attendance records', 'Access learning materials', 'Receive announcements', 'Message teachers & peers'] },
              { role: 'Teachers', color: 'border-blue-500/30 bg-violet-500/5', badge: 'bg-violet-500/20 text-violet-300', features: ['Input & manage grades', 'Record attendance', 'Upload learning materials', 'Post announcements', 'Communicate with students'] },

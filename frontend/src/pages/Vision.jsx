    ...
    <div className="bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-start justify-between gap-6">
            <div className="max-w-2xl">
              <p className="text-xs font-bold text-purple-200 uppercase tracking-widest mb-4">Our Aspiration</p>
      ...
      <section className="py-16 md:py-20 bg-purple-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl border-2 border-purple-200 p-8 md:p-12 shadow-lg">
            <div className="flex items-start gap-6 mb-8">
              <div className="w-16 h-16 rounded-2xl bg-purple-600 flex items-center justify-center shadow-lg flex-shrink-0">
              ...
              <div className="flex-1">
                <h2 className="text-2xl md:text-3xl font-black text-purple-800 mb-4 uppercase">Vision Statement</h2>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-black text-purple-800 mb-3 uppercase">Strategic Goals</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="bg-purple-50 rounded-2xl border-2 border-purple-200 p-6 hover:shadow-lg transition-all">
                <div className="text-5xl font-black text-purple-300 mb-2">{goal.year}</div>
                <h3 className="text-lg font-black text-purple-800 mb-2 uppercase">{goal.title}</h3>
              ...
              <div className="grid grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="text-center">
                    ...
                    <div className="text-xs text-purple-200 uppercase font-bold">{stat.label}</div>
                  </div>
                ))}
              </div>
            </div>

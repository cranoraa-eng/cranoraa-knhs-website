...
from .models import (Profile, Classroom, StudentClassEnrollment, Announcement,
    ...
    Notification, NotificationPreference, EnrollmentApplication, EnrollmentDocument, EnrollmentStatusHistory,
    ...
    ParentTeacherMeeting, BehavioralRecord, SchoolEvent, UserBlock, EmergencyMessage,
...
class SystemSettingSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['site_name', 'school_address', 'school_phone', 'school_email', 'school_logo', 
                  ...
                  'default_ww_weight', 'default_pt_weight', 'default_qa_weight', 'passing_grade',
...
# ═══════════════════════════════════════════════════════════════════════════════
# COMMUNICATION CENTER — Ticket Serializers
# ═══════════════════════════════════════════════════════════════════════════════
...
class TicketDetailSerializer(serializers.ModelSerializer):
    """Full serializer for ticket detail view with messages and participants."""
    created_by_name = serializers.SerializerMethodField()
    created_by_role = serializers.CharField(source='created_by.role', read_only=True)
    assigned_to_name = serializers.SerializerMethodField()
